...
const Login = () => {
	...
	const handleLogin = () => {
		signInWithEmailAndPassword(auth, email.current.value, pass.current.value).catch((error) => {
			alert(error);
		});
	};

	return (
		<div className="bg-bg h-screen overflow-hidden flex items-center justify-center">
			<div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
				...
				<div className="p-12 md:p-24">
					...
					<button
						className="bg-linear-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded"
						onClick={handleLogin}
					>
						Login
					</button>
